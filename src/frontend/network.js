 ...
 */
function loadGraph() {
	// Create the overlay for blurring the background
	...
	popup.style.maxWidth = "90%"; // Ensure it doesn't exceed the viewport width

	// Add the image
	const img = document.createElement("img");
	img.src = "../../plots/Heatmap_fm1_hMM2_hmm2.png"; // Replace with the actual PNG path
	img.alt = "Sample Image";
	img.style.width = "100%"; // Make the image fit the popup width
	img.style.borderRadius = "8px";
	popup.appendChild(img);

	// Add the text
	const text = document.createElement("p");
	text.textContent = "This is a sample PNG image.";
	text.style.marginTop = "10px";
	text.style.color = "#333";
	text.style.fontSize = "14px"; // Slightly smaller font size
